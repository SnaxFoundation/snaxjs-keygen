...
<dd><p>Public Key (SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV)</p>
</dd>
...
<dd><p>Private key object from snaxjs-ecc.</p>
</dd>
...
<dd><p>Permissions object from Snax blockchain obtained via get_account.</p>
...
Integration for 'snaxjs' ..
    ...
    like snaxjs may be provided these available public keys to snaxd
...
**See**: https://github.com/snax/snaxjs  
...
Public Key (SNAX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV)
...
Private key object from snaxjs-ecc.
...
required_auth: {
  threshold: 1,
  keys: [{
      key: 'SNAX78Cs5HPKY7HKHrSMnR76uj7yeajPuNwSH1Fsria3sJuufwE3Zd',
      weight: 1
    }
  ],
  accounts: []
...
Permissions object from Snax blockchain obtained via get_account.
